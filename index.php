                        ...
                        <div class="col-xl-8 col-xxl-9 col-lg-8">
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                ...
                                <div class="card-body p-0 d-flex">
                                    ...
                                    <h4 class="fw-700 text-grey-900 font-xssss mt-1">Liên Chi Đoàn Khoa Fast <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">3 hour ago</span></h4>
                                    <div class="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                                        <a href="#" class="p-2 lh-20 w100 bg-success me-2 text-white text-center font-xssss fw-600 ls-1 rounded-xl">Duyệt</a>
                                        <a href="#" class="p-2 lh-20 w100 bg-warning me-2 text-white text-center font-xssss fw-600 ls-1 rounded-xl">Xóa</a>
                                    </div>
                                    <a href="#" class="ms-auto" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false"><i class="ti-more-alt text-grey-900 btn-round-md bg-greylight font-xss"></i></a>
                                    <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu2">
                                        <div class="card-body p-0 d-flex">
                                            <i class="feather-bookmark text-grey-500 me-3 font-lg"></i>
                                            <h4 class="fw-600 text-grey-900 font-xssss mt-0 me-4">Lưu hoạt động <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Lưu hoạt động</span></h4>
                                        </div>
                                        <div class="card-body p-0 d-flex mt-2">
                                            <i class="feather-alert-circle text-grey-500 me-3 font-lg"></i>
                                            <h4 class="fw-600 text-grey-900 font-xssss mt-0 me-4">Ẩn hoạt động <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Ẩn hoạt động</span></h4>
                                        </div>
                                        <div class="card-body p-0 d-flex mt-2">
                                            <i class="feather-alert-octagon text-grey-500 me-3 font-lg"></i>
                                            <h4 class="fw-600 text-grey-900 font-xssss mt-0 me-4">Quản lý hoạt động<span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Quản lý hoạt động của bạn</span></h4>
                                        </div>
                                    </div>
                                </div>
                                <!-- Description of activity -->
                                <div class="card-body p-0 me-lg-5">
                                    <h5>Chào đón tân sinh viên khoa Fast 2023-2024</h5> <br>
                                    <p class="fw-500 text-grey-900 lh-26 font-xsss w-100">
                                        
                                    ---------------------------------------<br>
💥Bạn là sinh viên năm nhất, đang băn khoăn không biết nên vào tổ chức nào để gắn bó trong những năm đại học sắp tới?<br>
💥Bạn là sinh viên năm hai khao khát thể hiện bản thân, chứng tỏ năng lực nhưng chưa có cơ hội?<br>
💥Bạn năng động, tự tin, sáng tạo và mong muốn tham gia tổ chức những sự kiện lớn cùng các thầy cô giáo cực thân thiện, gần gũi và các anh chị khoá trên cool ngầu?<br>
❤️❤️❤️LIÊN CHI ĐOÀN KHOA KHOA HỌC CÔNG NGHỆ TIÊN TIẾN ĐANG CHỜ CÁC BẠN❤️❤️❤️<br>
🥳 Nhanh tay đăng ký tại link này nào các FASTER ơi!!! https://forms.gle/AqrJvJk2KZWKANqeA<br>
---------------------------------------<br>
Tiêu chí chung:<br>
- Là sinh viên thuộc Khoa FAST.<br>
- Khả năng làm việc nhóm tốt, có kĩ năng quan sát – bao quát công việc, giải quyết nhanh chóng các vấn đề.<br>
- Khả năng quản lý thời gian tốt để phân bổ hợp lý cho công việc.<br>
- Trung thực, nhiệt tình và có trách nhiệm cao với công việc.<br>
- Có kinh nghiệm tổ chức sự kiện là một lợi thế.<br>
📽 Ban truyền thông<br>
 Nơi hội tụ những bộ óc sáng tạo, dựng video, làm phim,...Ở ban này, bạn có nhiệm vụ đưa ra các ý tưởng và hoạch định các 
 chiến dịch truyền thông. Thành viên trong ban có thể cải thiện và phát triển các kỹ năng truyền thông của mình như tạo nội dung, 
 thiết kế ấn phẩm truyền thông, có khả năng viết lách tốt về sự kiện.<br>
⚙️ Ban kĩ thuật:<br>
- Có kĩ năng sử dụng powerpoint, khả năng xây dựng bài trình chiếu<br>
- Có hiểu biết về máy móc như mắc bóng đèn :v <br>
- Có trách nhiệm với công việc và linh hoạt thời gian.<br>
🧩 Ban nhân sự<br>
 Khả năng giao tiếp, xử lí tình huống tốt; Năng nổ, linh hoạt trong công việc. Có trách nhiệm hỗ trợ và quản lý các thành viên của 
 ban tổ chức sự kiện như quản lý thông tin của thành viên và quản lý quyền lợi của thành viên. Đây là nơi bạn có thể rèn luyện kỹ 
 năng quản lý nhân sự sau khi ra trường,... <br>
----------------------------------------<br>
🧐LỢI ÍCH KHI THAM GIA SỰ KIỆN LẦN NÀY CỦA LIÊN CHI ĐOÀN LÀ GÌ ?<br>
⭐️Đến với sự kiện sắp tới LCĐ, bạn sẽ có cơ hội được giao lưu học hỏi, chia sẻ kinh nghiệm cũng như phát triển tài năng của bản thân.<br>
⭐️Và tất nhiên các bạn sẽ được cộng điểm rèn luyện trong kỳ này.<br>
✌️Các bạn đã sẵn sàng khởi đầu hành trình mới của riêng mình chưa nào??? Tại sao không chọn FAST để gắn bó.<br>
----------------------------------------<br>
𝑻𝒉𝒐̂𝒏𝒈 𝒕𝒊𝒏 𝒍𝒊𝒆̂𝒏 𝒉𝒆̣̂:<br>
Fanpage LCĐ Khoa Khoa học Công nghệ Tiên tiến: https://www.facebook.com/lcd.fast.dut<br>
Email: fast.youthunion@gmail.com<br>
Leader: Phó Bí Thư- Huỳnh Thị Kiều Trinh - sđt: 0935350245<br>
#FAST<br>
#LCĐFAST<br>
                                ...
                                <div class="card-body d-block p-0 mb-3">
                                    <div class="row ps-2 pe-2">
                                        <div class="col-sm-12 p-1"><a href="images/Poster-ex.jpg" data-lightbox="roadtr"><img src="images/Poster-ex.jpg" class="rounded-3 w-100" alt="image"></a></div>
                                    </div>
                                </div>
                                <div class="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                                ...
                                <div class="card-body d-flex p-0 mt-3">
                                    <!-- like -->
                                    <a href="#" class="emoji-bttn d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss me-2"></i> <i class="feather-heart text-white bg-red-gradiant me-2 btn-round-xs font-xss"></i>2.8K Like</a>
                                    <!-- Comment -->
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu21">
                                        ...
                                        <h4 class="fw-700 font-xssss mt-4 text-grey-500 d-flex align-items-center mb-3">Sao chép liên kết</h4>
