                                        ...
                                        while ($row = $result2->fetch_assoc()) {
                                            ...
                                            <div class="card-body p-0 me-lg-5">
                                                ...
                                                <div class="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                                                    ...
                                                    <a href="#" class="p-2 lh-20 w100 bg-primary-gradiant me-2 text-white text-center font-xssss fw-600 ls-1 rounded-xl">Huy Dang Ky</a>
                                                    <a href="#" class="p-2 lh-20 w100 bg-primary-gradiant me-2 text-white text-center font-xssss fw-600 ls-1 rounded-xl">Dang Ky</a>
                                                </div>
