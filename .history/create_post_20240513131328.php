    ...
    <div class="main-wrapper">
        ...
        <div class="main-content ">
            <div style="padding: 100px 20px 20px 20px; max-width: 50%; min-width: 500px;">
                ...
                <form style="max-width: 100%;" action="/Users/nhattruong/Desktop/Activity-management-WEB-for-student-of-Danang/server/createPost.php" method="post" enctype="multipart/form-data">
                    <div class="form-group icon-input mb-3">
                        <label for="name" class="font-xss fw-60">Ten hoat dong</label>
                        <input type="text" id="name" name="name" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-60" placeholder="Ten hoat dong" required maxlength="60">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div style="display:flex;">
                            <div class="form-group icon-input mb-3">
                                ...
                                <input type="date" id="date_start_regis" name="date_start_regis"class="style2-input ps-5 form-control text-grey-900 font-xsss fw-60" placeholder="Ngày bắt đầu" required>
                            </div>
                            <div class="form-group icon-input mb-3">
                                <label for="date_end_regis" class="font-xsss fw-60">Ngày kết thúc</label>
                                <input type="date" id="date_end_regis" name="date_end_regis" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-60" placeholder="Ngày kết thúc" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group icon-input mb-3">
                    ...
                    <div class="form-group icon-input mb-3">
                        <label for="image" class="font-xsss fw-60">Ảnh đính kèm</label>
                        <input type="file" id="image" name="image" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-60">
                    </div>
