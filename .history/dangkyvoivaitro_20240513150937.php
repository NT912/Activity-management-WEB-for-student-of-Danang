            ...
            <div class="col-xl-7 vh-100 align-items-center d-flex bg-white rounded-3 overflow-hidden">
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <a href="dangky_NTC.php" class="mb-4 bg-current fw-700 text-white font-sm p-3 ms-2 text-center lh-20 rounded-xl d-block">Đăng ký với nhà tổ chức</a>
                        <!-- Tùy chọn đăng ký mới: Đăng ký với tư cách sinh viên -->
                        <a href="dangky_SV.php" class="mb-0 bg-current fw-700 text-white font-sm p-3 ms-2 text-center lh-20 rounded-xl d-block">Đăng ký với tư cách sinh viên</a>
                    </div>
                </div>
            </div>
        </div>
