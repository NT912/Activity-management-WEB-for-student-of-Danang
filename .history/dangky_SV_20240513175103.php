...
<head>
    ...
    <script>
        ...
        function checkInputPasswordAgain() {
            var password = document.forms["registerForm"]["matkhau"].value;
        ...
        function updateMajorName() {
            ...
            xhr.open("GET", "./server/get_major_name.php?major_id=" + majorId, true);
            xhr.send();
        }
            ...
            <div class="col-xl-7 vh-100 align-items-center d-flex bg-white rounded-3 overflow-hidden">
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="post" action="./server/DangKySV.php" name="registerForm">
                            ...
                            <div class="form-group icon-input mb-3">
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                                <input type="password" name="nhaplaimatkhau" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Nhập lại mật khẩu" onblur="validateInput('nhaplaimatkhau'); checkInputPasswordAgain();" required>
