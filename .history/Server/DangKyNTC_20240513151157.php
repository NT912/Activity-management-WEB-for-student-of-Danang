        ...
        if ($result_check) {
            ...
            if ($total > 0) {
                ...
                if ($conn->query($sql_organization) === TRUE) {
                    ...
                    $role = 'organization';
                    $sql_user = "INSERT INTO user (Name, Email, Password, Id_organization, role)
                                VALUES ('$name_organization', '$email', '$hashed_password', '$id_organization', '$role')";
                    if ($conn->query($sql_user) === TRUE) {
                        echo "<script>alert('Đăng ký thành công.');</script>";
                        // Chuyển hướng sang trang login.php
                        header("Location: /Users/nhattruong/Desktop/Activity-management-WEB-for-student-of-Danang/login.php");
