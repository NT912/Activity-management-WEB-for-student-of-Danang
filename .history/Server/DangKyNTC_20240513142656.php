...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_organization) || empty($email) || empty($password)) {
        ...
        if ($result_check->num_rows > 0) {
            ...
            $sql_organization = "INSERT INTO organization (Name, Email, Password, Description, Address, Phone)
                        VALUES ('$name_organization', '$email', '$hashed_password', '$description', '$address', '$phone')";
