...
include 'DB/database.php'; // Đảm bảo đường dẫn đến file database.php là chính xác
...
if(isset($_POST['submit'])) {
    ...
    $date_start_regis = $_POST['date_start_regis'];
    $date_end_regis = $_POST['date_end_regis'];
    ...
    $sql = "INSERT INTO activity (Id_activity, Id_organization, Name, Date_start, Date_end, Date_start_regis, Date_end_regis, Location, Content, Image)
