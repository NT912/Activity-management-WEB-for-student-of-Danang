...
if(isset($_POST['submit'])) {
    ...
    $organization_id = "Id_organization"; // Thay bằng phương thức lấy id tự động từ 2 table liên quan
    ...
    $sql = "INSERT INTO activity (Id_activity, Id_organization, Name_activity, Date_start, Date_end, Date_start_registe, Date_end_registe, Location, Description, Image)
