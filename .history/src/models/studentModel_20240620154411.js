...
studentModel.updateContactInfo = async (student_id, email, phone) => {
  const query = "INSERT INTO students (email, phone) WHERE masv = ?";
  await db.execute(query, [email, phone, student_id]);
};
