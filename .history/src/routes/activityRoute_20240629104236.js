...
// API routes
// Route API để tạo hoạt động mới
router.post(
  "/api/create",
  authMiddleware.isOrganizationOrAdmin,
  upload.single("poster"),
  controller.apiAddActivity
);

// Route API để lấy danh sách hoạt động
router.get(
  "/api/list",
  authMiddleware.isOrganizationOrAdmin,
  controller.apiGetActivities
);
