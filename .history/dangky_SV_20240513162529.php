...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $major_name = $_POST["major_name"]; // Thêm trường này để lưu tên của khoa
    ...
    if (empty($hoten) || empty($masv) || empty($matkhau) || empty($lop) || empty($khoa)) {
        ...
        if ($result_check->num_rows > 0) {
            ...
            $sql_user = "INSERT INTO user (Id, Name, Email, Password, major_id, role) VALUES ('$id_student', '$hoten', '$masv', '$matkhau', '$khoa', 'student')";
            $result_user = $conn->query($sql_user);

            if ($result_user === TRUE) {
                // Thêm thông tin sinh viên vào bảng student
                $sql_student = "INSERT INTO student (Name, MaSV, lopsinhoat, major, Id) VALUES ('$hoten', '$masv', '$lop', '$major_name', '$id_student')";
                ...
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" name="registerForm">
                            ...
                            <div class="form-group icon-input mb-3">
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                                <select name="major" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600 select-dropdown" onchange="updateMajorName(); validateInput()">
