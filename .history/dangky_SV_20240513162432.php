...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($hoten) || empty($masv) || empty($matkhau) || empty($lop) || empty($khoa)) {
        ...
        if ($result_check->num_rows > 0) {
            ...
            $sql_user = "INSERT INTO user (Name, Email, Password, major_id, role) VALUES ('$hoten', '$masv', '$matkhau', '$khoa', 'student')";
            ...
            if ($result_user === TRUE) {
                ...
                $sql_student = "INSERT INTO student (Name, MaSV, lopsinhoat, major, Id_user) VALUES ('$hoten', '$masv', '$lop', '$major_name', '$last_user_id')";
