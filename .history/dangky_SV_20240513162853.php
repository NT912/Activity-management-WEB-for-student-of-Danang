...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($hoten) || empty($masv) || empty($matkhau) || empty($lop) || empty($major_name)) {
        ...
        if ($result_check->num_rows > 0) {
            ...
            $sql_user = "INSERT INTO user (Name, Email, Password, major_id, role) VALUES ('$hoten', '$masv', '$matkhau', (SELECT Id FROM major WHERE name = '$major_name'), 'student')";
            ...
            if ($result_user === TRUE) {
                ...
                $sql_student = "INSERT INTO student (Name, MaSV, lopsinhoat, major, Id_user) VALUES ('$hoten', '$masv', '$lop', (SELECT Id FROM major WHERE name = '$major_name'), '$last_user_id')";
            ...
            <div class="col-xl-7 vh-100 align-items-center d-flex bg-white rounded-3 overflow-hidden">
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="post" action="process_register.php" name="registerForm">
