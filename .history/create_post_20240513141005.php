            ...
            <div style="padding: 100px 20px 20px 20px; max-width: 50%; min-width: 500px;">
                ...
                <div class="form-group icon-input mb-3">
                    ...
                    <div class="form-group icon-input mb-3">
                        ...
                        <textarea id="Description" name="Description" class="style2-input ps-5 form-control-textarea text-grey-900 fw-60" style="height: 400px" placeholder="Nội dung hoạt động" required></textarea>
                    </div>
                    <div class="form-group icon-input mb-3">
