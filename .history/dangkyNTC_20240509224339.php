...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_orginization) || empty($masv) || empty($matkhau) || empty($lop) || empty($khoa)) {
        ...
        if ($result_check->num_rows > 0) {
            ...
            $sql_student = "INSERT INTO Student (Name, MaSV, Password, lopsinhoat, major) VALUES ('$name_orginization', '$masv', '$matkhau', '$lop', '$khoa')";
