...
// Lấy vai trò của người dùng từ URL
$role = $_GET['role'] ?? '';

// Xác định xem có nên hiển thị phần "Create Post" hay không dựa trên vai trò
$showCreatePost = ($role === 'organization');

// Orginization_information query
$sql_Orginization_information = "SELECT * FROM Orginization_information WHERE role = '$role'";
// Thực thi truy vấn
...
$sql_Activity = "SELECT * FROM Activity WHERE role = '$role' ORDER BY created_at DESC";
