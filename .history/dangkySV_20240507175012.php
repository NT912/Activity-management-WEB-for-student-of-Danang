                    ...
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" name="registerForm">
                            ...
                            <div class="form-group icon-input mb-3">
                                ...
                                <span id="errorPasswordAgaint" style="color: red; display: none;">Vui lòng nhập lại mật khẩu.</span>
                            </div>
                            <div class="form-group icon-input mb-3">
                                ...
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                                <span id="errorHoten" style="color: red; display: none;">Vui lòng nhập lớp.</span>
                            </div>
                            <div class="form-group icon-input mb-1">
                                ...
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                                <span id="errorHoten" style="color: red; display: none;">Vui lòng nhập khoa.</span>
                            </div>
