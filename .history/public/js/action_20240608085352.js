function ConfirmStudentRegister(
  activityId,
  studentId,
  isConfirmed,
  checkboxId
  ...
  fetch(
    `/activity/confirmStudentRegister?activity_id=${activityId}&student_id=${studentId}&is_confirmed=${isConfirmed}`,
    {
      method: "POST",
      headers: {
