...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_orginization) || empty($email) || empty($matkhau) || empty($id_orginization)) {
        ...
        if ($result_check->num_rows > 0) {
            ...
            $sql_student = "INSERT INTO Orginization_information (Id_orginization, Name_orginization, Email, Password) VALUES ('$name_orginization', '$id_orginization', '$matkhau', '$lop', '$khoa')";
