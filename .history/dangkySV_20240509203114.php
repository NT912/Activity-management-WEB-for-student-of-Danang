                    ...
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" name="registerForm">
                            ...
                            <div class="form-group icon-input mb-3">
                                ...
                                <input type="password" name="nhaplaimatkhau" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Nhập lại mật khẩu" onblur="validateInput('nhaplaimatkhau')" onblur="checkInputPasswordAgain()">
