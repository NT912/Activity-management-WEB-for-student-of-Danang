                ...
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form>
                            ...
                            <div class="form-group icon-input mb-3">
                                <i class="font-sm ti-user text-grey-500 pe-0"></i>
                                <input type="text" name="gmail" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Gmail" onblur="validateInput('id')">
                                <span id="errorGmail" style="color: red; display: none;">Vui lòng nhập ID nhà tổ chức.</span>
                            </div>
                            <div class="form-group icon-input mb-3">
