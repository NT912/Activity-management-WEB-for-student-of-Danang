                ...
                <div class="card shadow-none border-0 ms-auto me-auto login-card">
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <div class="form-group icon-input mb-3">
                                <i class="font-sm ti-email text-grey-500 pe-0"></i>
                                <input type="password" name="matkhau" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Mật khẩu">
                            </div>
                            <div class="form-group icon-input mb-3">
                            ...
                            <div class="form-group icon-input mb-3">
                                <input type="text" name="lop" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Lớp sinh hoạt">
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                            </div>
                            <div class="form-group icon-input mb-1">
                                <input type="text" name="khoa" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Khoa">
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                            </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result_check->num_rows > 0) {
        ...
        $sql_student = "INSERT INTO Student (Name, MaSV, Password, lopsinhoat, Agree) VALUES ('$hoten', '$masv', '$matkhau', '$lop', $agree)";
